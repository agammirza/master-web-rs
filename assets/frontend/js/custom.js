...
var headerHeight = $('.boxed_wrapper > .header').height();
...
function stickyHeader() {
    $('.boxed_wrapper > .header').css('height', headerHeight+"px");
    if ($('.stricky').length) {
...
function flyout() {
    var flyoutHeight = $('#flyout').width();
    var screenHeight = $(window).height();
    var margin = screenHeight - flyoutHeight;
    $('#flyout').css('top', (margin / 2) + 220);
