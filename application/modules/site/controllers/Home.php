...
class Home extends SiteController
{
	...
	public function index()
	{
		...
		$this->template->site($this->theme, 'index', $data, function () {
			...
			$this->load->view('themes/' . $this->theme . '/part/slider');
			$this->load->view('themes/' . $this->theme . '/part/layanan_online');
			$this->load->view('themes/' . $this->theme . '/part/dokter');
			$this->load->view('themes/' . $this->theme . '/part/spesialis1');
			// $this->load->view('themes/' . $this->theme . '/part/fasilitas');
			$this->load->view('themes/' . $this->theme . '/part/fasilitas_layanan');
			$this->load->view('themes/' . $this->theme . '/part/berita1');
			$this->load->view('themes/' . $this->theme . '/part/artikel');
			$this->load->view('themes/' . $this->theme . '/part/qoute');
			// $this->load->view('themes/' . $this->theme . '/part/asuransi');
